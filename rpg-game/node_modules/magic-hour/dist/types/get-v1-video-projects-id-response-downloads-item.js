...
exports.Schemas$GetV1VideoProjectsIdResponseDownloadsItem = void 0;
 ...
 */
const SchemaIn$GetV1VideoProjectsIdResponseDownloadsItem = z
    .object({
    expires_at: z.string(),
    url: z.string(),
})
 ...
 */
const SchemaOut$GetV1VideoProjectsIdResponseDownloadsItem = z
    .object({
    expiresAt: z.string(),
    url: z.string(),
})
...
exports.Schemas$GetV1VideoProjectsIdResponseDownloadsItem = {
