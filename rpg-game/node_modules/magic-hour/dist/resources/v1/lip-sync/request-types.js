...
const post_v1_lip_sync_body_assets_1 = require("../../../types/post-v1-lip-sync-body-assets");
...
const SchemaIn$CreateRequest = z
    .object({
    assets: post_v1_lip_sync_body_assets_1.Schemas$PostV1LipSyncBodyAssets.in,
...
const SchemaOut$CreateRequest = z
    .object({
    assets: post_v1_lip_sync_body_assets_1.Schemas$PostV1LipSyncBodyAssets.out,
    endSeconds: z.number(),
    height: z.number().int(),
